...
public final class ScopeSwitchState {
    ...
    public static Optional<Float> customScopeAimTime(ItemStack gun) {
        return customScopeAimTime(gun, -1.0F);
    }

    public static Optional<Float> customScopeAimTime(ItemStack gun, float baseAimTime) {
        ...
        // base: 传入全配件修饰后的开镜时间; 无传入时退化为枪械基础值
        float base = baseAimTime >= 0.0F ? baseAimTime
