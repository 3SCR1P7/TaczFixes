...
public final class DualFocusAimKey {
    public static final KeyMapping FOCUS_AIM_KEY = new KeyMapping("key.taczfixes.focus_aim", KeyConflictContext.IN_GAME, KeyModifier.NONE, InputConstants.Type.KEYSYM, 66, "key.categories.taczfixes");
