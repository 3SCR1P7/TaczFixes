...
public class Config {
    ...
    static {
        ...
        JUMP_INACCURACY_DEFAULT_MULTIPLIER = BUILDER
                .comment("枪械data未配置 jump_inaccuracy 时默认的滞空散布倍率。默认值：1.0")
                .defineInRange("jump_default_multiplier", 1.0, 0.0, 10.0);
        JUMP_INACCURACY_DEFAULT_SPEED = BUILDER
        ...
        RECOIL_KNOCKBACK_MULTIPLIER = BUILDER
                .comment("开火击退的力度大小。默认值：0.01")
                .defineInRange("multiplier", 0.01, 0.0, 1.0);
        ...
        DISABLE_HITBOXES = BUILDER
                ...
                .define("disable_hitboxes", false);        DISABLE_THIRD_PERSON = BUILDER
