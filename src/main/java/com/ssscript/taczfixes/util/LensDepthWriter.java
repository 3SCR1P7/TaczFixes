...
import com.ssscript.taczfixes.mixin.MixinBedrockAttachmentModelScopeSuppress;
...
public final class LensDepthWriter {
    ...
    public static void writeLensDepth(ItemStack item, ItemStack gun, PoseStack poseStack,
        ...
        TimelessAPI.getClientAttachmentIndex(attachment.getAttachmentId(item)).ifPresent(index -> {
